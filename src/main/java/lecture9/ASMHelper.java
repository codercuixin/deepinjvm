...
//第一步javac lecture9/Circuit.java
//我这里用来idea来执行二三步骤
...
public class ASMHelper implements Opcodes {
  ...
  private static class MyMethodVisitor extends MethodVisitor {
    ...
    private static final String BOOTSTRAP_METHOD_NAME = "lecture9.MonomorphicInlineCache";
  ...
  public static void main(String[] args) throws IOException {
    Paths.get("Circuit.class");
    ClassReader cr = new ClassReader("lecture9.Circuit");
    ...
    //覆盖以前的类
    Files.write(Paths.get("src/main/java/lecture9/Circuit.class"), cw.toByteArray());
  }
}
