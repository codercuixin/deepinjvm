...
import lecture28.test.src.main.java.org.sample.generated.JMHSample_03_Status_BenchmarkState_jmhType;
import lecture28.test.src.main.java.org.sample.generated.JMHSample_03_Status_jmhType;
public final class JMHSample_03_Status_measureShared_jmhTest {
    ...
    public BenchmarkTaskResult measureShared_Throughput(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            JMHSample_03_Status_BenchmarkState_jmhType l_benchmarkstate1_G = _jmh_tryInit_f_benchmarkstate1_G(control);
            ...
            while (control.warmupShouldWait) {
                l_jmhsample_03_status0_0.measureShared(l_benchmarkstate1_G);
                res.allOps++;
            }

            notifyControl.startMeasurement = true;
            measureShared_thrpt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_benchmarkstate1_G, l_jmhsample_03_status0_0);
    ...
    public static void measureShared_thrpt_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, JMHSample_03_Status_BenchmarkState_jmhType l_benchmarkstate1_G, JMHSample_03_Status_jmhType l_jmhsample_03_status0_0) throws Throwable {
        long operations = 0;
        long realTime = 0;
    ...
    public BenchmarkTaskResult measureShared_AverageTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            notifyControl.startMeasurement = true;
            measureShared_avgt_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, l_benchmarkstate1_G, l_jmhsample_03_status0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public BenchmarkTaskResult measureShared_SampleTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            measureShared_sample_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, buffer, targetSamples, opsPerInv, batchSize, l_benchmarkstate1_G, l_jmhsample_03_status0_0);
            notifyControl.stopMeasurement = true;
            control.announceWarmdownReady();
            try {
                while (control.warmdownShouldWait) {
    ...
    public static void measureShared_sample_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, SampleBuffer buffer, int targetSamples, long opsPerInv, int batchSize, JMHSample_03_Status_BenchmarkState_jmhType l_benchmarkstate1_G, JMHSample_03_Status_jmhType l_jmhsample_03_status0_0) throws Throwable {
        long realTime = 0;
        long operations = 0;
    ...
    public BenchmarkTaskResult measureShared_SingleShotTime(InfraControl control, ThreadParams threadParams) throws Throwable {
        ...
        if (threadParams.getSubgroupIndex() == 0) {
            ...
            RawResults res = new RawResults();
            int batchSize = iterationParams.getBatchSize();
            measureShared_ss_jmhStub(control, res, benchmarkParams, iterationParams, threadParams, blackhole, notifyControl, startRndMask, batchSize, l_benchmarkstate1_G, l_jmhsample_03_status0_0);
            control.preTearDown();
    ...
    public static void measureShared_ss_jmhStub(InfraControl control, RawResults result, BenchmarkParams benchmarkParams, IterationParams iterationParams, ThreadParams threadParams, Blackhole blackhole, Control notifyControl, int startRndMask, int batchSize, JMHSample_03_Status_BenchmarkState_jmhType l_benchmarkstate1_G, JMHSample_03_Status_jmhType l_jmhsample_03_status0_0) throws Throwable {
        long realTime = 0;
        result.startTime = System.nanoTime();
        for (int b = 0; b < batchSize; b++) {
            if (control.volatileSpoiler) return;
    ...
    static volatile JMHSample_03_Status_BenchmarkState_jmhType f_benchmarkstate1_G;
    
    JMHSample_03_Status_BenchmarkState_jmhType _jmh_tryInit_f_benchmarkstate1_G(InfraControl control) throws Throwable {
        JMHSample_03_Status_BenchmarkState_jmhType val = f_benchmarkstate1_G;
        if (val != null) {
            return val;
        }
        synchronized(this.getClass()) {
            ...
            val = new JMHSample_03_Status_BenchmarkState_jmhType();
            val.readyTrial = true;
